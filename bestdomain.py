...
if __name__ == "__main__":
    ...
    subdomain_ip_mapping = {
        'nezha': 'https://ipdb.030101.xyz/api/bestcf.txt',  # #域名一，bestcf.域名.com
        'nezha': 'https://raw.githubusercontent.com/gally16/youxuanyuming/refs/heads/main/ip.txt', #域名二，api.域名.com
        # 添加更多子域名和对应的IP列表URL
    }
